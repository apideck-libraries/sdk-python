...
class Connections(BaseSDK):
    ...
    def migrate(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.VaultConnectionsMigrateResponse:
        r"""Migrate connection
        ...
        :param service_id: Service ID of the resource to return
        :param unified_api: Unified API
        :param target_service_id: The service id of the connector to migrate this connection to. Must be one of the source connector's declared migration targets.
        :param consumer_id: ID of the consumer which you want to get or push data from
        :param app_id: The ID of your Unify application
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        ...
        request = models.VaultConnectionsMigrateRequest(
            consumer_id=consumer_id,
            app_id=app_id,
            service_id=service_id,
            unified_api=unified_api,
            connection_migrate_data=models.ConnectionMigrateData(
        ...
        req = self._build_request(
            method="POST",
            path="/vault/connections/{unified_api}/{service_id}/migrate",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.VaultConnectionsMigrateGlobals(
                consumer_id=self.sdk_configuration.globals.consumer_id,
                app_id=self.sdk_configuration.globals.app_id,
            ),
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.connection_migrate_data,
                False,
                False,
                "json",
                models.ConnectionMigrateData,
            ),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="vault.connectionsMigrate",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
            ...
            request=req,
            error_status_codes=["400", "401", "402", "404", "409", "422", "4XX", "5XX"],
            retry_config=retry_config,
        )

        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.VaultConnectionsMigrateResponse(
                create_connection_response=unmarshal_json_response(
                    Optional[models.CreateConnectionResponse], http_res
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
        ...
        if utils.match_response(http_res, "409", "application/json"):
            response_data = unmarshal_json_response(
                models.ConflictResponseData, http_res
            )
            raise models.ConflictResponse(response_data, http_res)
        if utils.match_response(http_res, "422", "application/json"):
            response_data = unmarshal_json_response(
                models.UnprocessableResponseData, http_res
            )
