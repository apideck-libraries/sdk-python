...
class Lists(BaseSDK):
    def list(
        ...
        *,
    ...
    ) -> Optional[models.CrmListsAllResponse]:
        r"""List lists
        ...
        request = models.CrmListsAllRequest(
            raw=raw,
        ...
        req = self._build_request(
            ...
            _globals=models.CrmListsAllGlobals(
        ...
        def next_func() -> Optional[models.CrmListsAllResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.CrmListsAllResponse(
                get_lists_response=unmarshal_json_response(
                    Optional[models.GetListsResponse], http_res
                ),
    ...
    def get(
        ...
        *,
        ...
        request = models.CrmListsOneRequest(
            id=id,
            consumer_id=consumer_id,
            app_id=app_id,
            service_id=service_id,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.CrmListsOneGlobals(
                consumer_id=self.sdk_configuration.globals.consumer_id,
                app_id=self.sdk_configuration.globals.app_id,
            ),
            security=self.sdk_configuration.security,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.CrmListsOneResponse(
                get_list_response=unmarshal_json_response(
                    Optional[models.GetListResponse], http_res
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
