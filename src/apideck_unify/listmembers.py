...
class ListMembers(BaseSDK):
    def list(
        ...
        *,
    ...
    ) -> Optional[models.CrmListMembersAllResponse]:
        r"""List list members
        ...
        request = models.CrmListMembersAllRequest(
            id=id,
            raw=raw,
        ...
        req = self._build_request(
            ...
            _globals=models.CrmListMembersAllGlobals(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="crm.listMembersAll",
                oauth2_scopes=None,
        ...
        def next_func() -> Optional[models.CrmListMembersAllResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.CrmListMembersAllResponse(
                get_list_members_response=unmarshal_json_response(
                    Optional[models.GetListMembersResponse], http_res
                ),
