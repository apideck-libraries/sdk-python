...
class ApideckHrisCompanies(BaseSDK):
    def all(
        ...
        *,
    ...
    ) -> Optional[models.HrisCompaniesAll2Response]:
        r"""List Companies
        ...
        request = models.HrisCompaniesAll2Request(
            raw=raw,
        ...
        req = self._build_request(
            ...
            _globals=models.HrisCompaniesAll2Globals(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="hris.companiesAll2",
                oauth2_scopes=None,
        ...
        def next_func() -> Optional[models.HrisCompaniesAll2Response]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.HrisCompaniesAll2Response(
