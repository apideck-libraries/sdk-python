...
class EcommerceStoreTypedDict(TypedDict):
    ...
    addresses: NotRequired[List[EcommerceAddressTypedDict]]
    r"""Seller-side addresses exposed by the platform for this store. Currently holds the store's default shipping origin when the platform designates one. Empty when none is available."""
...
class EcommerceStore(BaseModel):
    ...
    addresses: Optional[List[EcommerceAddress]] = None
    r"""Seller-side addresses exposed by the platform for this store. Currently holds the store's default shipping origin when the platform designates one. Empty when none is available."""
