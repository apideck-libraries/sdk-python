...
class CrmListsAllGlobalsTypedDict(TypedDict):
...
class CrmListsAllGlobals(BaseModel):
...
class CrmListsAllRequestTypedDict(TypedDict):
...
class CrmListsAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
...
class CrmListsAllResponseTypedDict(TypedDict):
    http_meta: HTTPMetadataTypedDict
    get_lists_response: NotRequired[GetListsResponseTypedDict]
    r"""Lists"""
    unexpected_error_response: NotRequired[UnexpectedErrorResponseTypedDict]
    r"""Unexpected error"""


class CrmListsAllResponse(BaseModel):
    next: Callable[[], Optional[CrmListsAllResponse]]

    http_meta: Annotated[Optional[HTTPMetadata], pydantic.Field(exclude=True)] = None

    get_lists_response: Optional[GetListsResponse] = None
    r"""Lists"""
