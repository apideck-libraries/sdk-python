...
class GoodsReceiptsSortBy(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""The field on which to sort the Goods Receipts"""

    UPDATED_AT = "updated_at"
    CREATED_AT = "created_at"


class GoodsReceiptsSortTypedDict(TypedDict):
    by: NotRequired[GoodsReceiptsSortBy]
    r"""The field on which to sort the Goods Receipts"""
    direction: NotRequired[SortDirection]
    r"""The direction in which to sort the results"""


class GoodsReceiptsSort(BaseModel):
    by: Annotated[
        Annotated[
            Optional[GoodsReceiptsSortBy], PlainValidator(validate_open_enum(False))
        ],
    ...
    def serialize_by(self, value):
        if isinstance(value, str):
            try:
                return models.GoodsReceiptsSortBy(value)
            except ValueError:
                return value
        return value
