...
class AccountingJournalsOneGlobalsTypedDict(TypedDict):
...
class AccountingJournalsOneGlobals(BaseModel):
...
class AccountingJournalsOneRequestTypedDict(TypedDict):
    id: str
...
class AccountingJournalsOneRequest(BaseModel):
    id: Annotated[
...
class AccountingJournalsOneResponseTypedDict(TypedDict):
    http_meta: HTTPMetadataTypedDict
    get_journal_response: NotRequired[GetJournalResponseTypedDict]
    r"""Journals"""
    unexpected_error_response: NotRequired[UnexpectedErrorResponseTypedDict]
    r"""Unexpected error"""


class AccountingJournalsOneResponse(BaseModel):
    http_meta: Annotated[Optional[HTTPMetadata], pydantic.Field(exclude=True)] = None

    get_journal_response: Optional[GetJournalResponse] = None
    r"""Journals"""
