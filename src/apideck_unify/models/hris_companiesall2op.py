...
class HrisCompaniesAll2GlobalsTypedDict(TypedDict):
...
class HrisCompaniesAll2Globals(BaseModel):
...
class HrisCompaniesAll2RequestTypedDict(TypedDict):
...
class HrisCompaniesAll2Request(BaseModel):
    raw: Annotated[
        Optional[bool],
...
class HrisCompaniesAll2ResponseTypedDict(TypedDict):
...
class HrisCompaniesAll2Response(BaseModel):
    next: Callable[[], Optional[HrisCompaniesAll2Response]]
