...
class GetBillCreditNotesResponseTypedDict(TypedDict):
    r"""Bill Credit Notes"""
    ...
    data: List[BillCreditNoteTypedDict]
...
class GetBillCreditNotesResponse(BaseModel):
    r"""Bill Credit Notes"""
