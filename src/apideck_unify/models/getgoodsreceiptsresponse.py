...
from .goodsreceipt import GoodsReceipt, GoodsReceiptTypedDict
...
class GetGoodsReceiptsResponseTypedDict(TypedDict):
    r"""GoodsReceipts"""
    ...
    data: List[GoodsReceiptTypedDict]
...
class GetGoodsReceiptsResponse(BaseModel):
    r"""GoodsReceipts"""
