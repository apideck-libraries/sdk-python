...
class AccountingJournalsAllGlobalsTypedDict(TypedDict):
...
class AccountingJournalsAllGlobals(BaseModel):
...
class AccountingJournalsAllRequestTypedDict(TypedDict):
...
class AccountingJournalsAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
...
class AccountingJournalsAllResponseTypedDict(TypedDict):
    http_meta: HTTPMetadataTypedDict
    get_journals_response: NotRequired[GetJournalsResponseTypedDict]
    r"""Journals"""
    unexpected_error_response: NotRequired[UnexpectedErrorResponseTypedDict]
    r"""Unexpected error"""


class AccountingJournalsAllResponse(BaseModel):
    next: Callable[[], Optional[AccountingJournalsAllResponse]]

    http_meta: Annotated[Optional[HTTPMetadata], pydantic.Field(exclude=True)] = None

    get_journals_response: Optional[GetJournalsResponse] = None
    r"""Journals"""
