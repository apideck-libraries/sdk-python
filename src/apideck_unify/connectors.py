        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ConnectorConnectorsAllResponse(
                get_connectors_response=unmarshal_json_response(
                    Optional[models.GetConnectorsResponse], http_res
                ),
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ConnectorConnectorsOneResponse(
                get_connector_response=unmarshal_json_response(
                    Optional[models.GetConnectorResponse], http_res
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "401", "application/json"):
