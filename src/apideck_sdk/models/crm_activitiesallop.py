...
CrmActivitiesAllResponseTypedDict = TypeAliasType(
    "CrmActivitiesAllResponseTypedDict",
    Union[UnexpectedErrorResponseTypedDict, GetActivitiesResponseTypedDict],
)


CrmActivitiesAllResponse = TypeAliasType(
    "CrmActivitiesAllResponse", Union[UnexpectedErrorResponse, GetActivitiesResponse]
)
