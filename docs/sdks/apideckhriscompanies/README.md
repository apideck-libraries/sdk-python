...
<!-- UsageSnippet language="python" operationID="hris.companiesAll2" method="get" path="/hris/companies" -->
```python
...
with Apideck(
    ...
    res = apideck.hris.companies.all(raw=False, service_id="salesforce", limit=20, pass_through={
...
**[models.HrisCompaniesAll2Response](../../models/hriscompaniesall2response.md)**
...
with Apideck(
    ...
    res = apideck.hris.companies.create(raw=False, service_id="salesforce", legal_name="SpaceX", display_name="SpaceX", subdomain="company", status=apideck_unify.HrisCompanyStatus.ACTIVE, company_number="123456-AB", currency=apideck_unify.Currency.USD, addresses=[
...
| `app_id`                                                                                                                                                | *Optional[str]*                                                                                                                                         | :heavy_minus_sign:                                                                                                                                      | The ID of your Unify application                                                                                                                        | dSBdXd2H6Mqwfg0atXHXYcysLJE9qyn1VwBtXHX                                                                                                                 |
| `service_id`                                                                                                                                            | *Optional[str]*                                                                                                                                         | :heavy_minus_sign:                                                                                                                                      | Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.           | salesforce                                                                                                                                              |
| `legal_name`                                                                                                                                            | *OptionalNullable[str]*                                                                                                                                 | :heavy_minus_sign:                                                                                                                                      | N/A                                                                                                                                                     | SpaceX                                                                                                                                                  |
...
with Apideck(
    ...
    res = apideck.hris.companies.update(id="<id>", service_id="salesforce", raw=False, legal_name="SpaceX", display_name="SpaceX", subdomain="company", status=apideck_unify.HrisCompanyStatus.ACTIVE, company_number="123456-AB", currency=apideck_unify.Currency.USD, addresses=[
        apideck_unify.Address(
            id="123",
            type=apideck_unify.Type.PRIMARY,
            string="25 Spring Street, Blackburn, VIC 3130",
