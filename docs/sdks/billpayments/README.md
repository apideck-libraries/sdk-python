...
with Apideck(
    ...
    res = s.accounting.bill_payments.list(request={
    ...
    if res.get_bill_payments_response is not None:
        # handle response
        pass
...
**[models.AccountingBillPaymentsAllResponse](../../models/accountingbillpaymentsallresponse.md)**
...
**[models.AccountingBillPaymentsAddResponse](../../models/accountingbillpaymentsaddresponse.md)**
...
with Apideck(
    ...
    res = s.accounting.bill_payments.get(id="<id>", service_id="salesforce", fields="id,updated_at")

    if res.get_bill_payment_response is not None:
        # handle response
        pass
...
with Apideck(
    ...
    if res.update_bill_payment_response is not None:
        # handle response
        pass
...
with Apideck(
    ...
    res = s.accounting.bill_payments.delete(id="<id>", service_id="salesforce")

    if res.delete_bill_payment_response is not None:
        # handle response
        pass
