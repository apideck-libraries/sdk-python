...
| ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `request`                                                                           | [models.AccountingPaymentsAllRequest](../../models/accountingpaymentsallrequest.md) | :heavy_check_mark:                                                                  | The request object to use for the request.                                          |
...
with Apideck(
    ...
    res = s.accounting.payments.create(payment={
        ...
        "type": apideck_unify.PaymentType.ACCOUNTS_RECEIVABLE,
        "allocations": [
            {
                "id": "123456",
                "amount": 49.99,
