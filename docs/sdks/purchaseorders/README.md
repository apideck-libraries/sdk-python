...
with Apideck(
    ...
    res = apideck.accounting.purchase_orders.list(request={
...
with Apideck(
    ...
    res = apideck.accounting.purchase_orders.create(purchase_order={
        "po_number": "90000117",
        "reference": "123456",
        "supplier": {
            "id": "12345",
...
with Apideck(
    ...
    res = apideck.accounting.purchase_orders.update(id="<id>", purchase_order={
        "po_number": "90000117",
        "reference": "123456",
        "supplier": {
            "id": "12345",
