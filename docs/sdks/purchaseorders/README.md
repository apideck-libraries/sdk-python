...
<!-- UsageSnippet language="python" operationID="accounting.purchaseOrdersAll" method="get" path="/accounting/purchase-orders" -->
```python
...
with Apideck(
    ...
    res = apideck.accounting.purchase_orders.list(raw=False, service_id="salesforce", company_id="12345", pass_through={
...
<!-- UsageSnippet language="python" operationID="accounting.purchaseOrdersAdd" method="post" path="/accounting/purchase-orders" -->
```python
import apideck_unify
from apideck_unify import Apideck
...
with Apideck(
    ...
    res = apideck.accounting.purchase_orders.create(raw=False, service_id="salesforce", company_id_param="12345", display_id="12345", po_number="90000117", reference="123456", supplier=apideck_unify.LinkedSupplierInput(
        id="12345",
    ...
    ), subsidiary_id="12345", company_id="12345", location_id="12345", department_id="12345", status=apideck_unify.PurchaseOrderStatus.OPEN, issued_date=date.fromisoformat("2020-09-30"), delivery_date=date.fromisoformat("2020-09-30"), expected_arrival_date=date.fromisoformat("2020-09-30"), currency=apideck_unify.Currency.USD, currency_rate=0.69, sub_total=27500, total_tax=2500, total=27500, tax_inclusive=True, line_items=[
        ...
        nominal_code="N091",
        code="453",
    ), template_id="123456", discount_percentage=5.5, bank_account=apideck_unify.BankAccount(
        bank_name="Monzo",
...
| `display_id`                                                                                                                                                 | *OptionalNullable[str]*                                                                                                                                      | :heavy_minus_sign:                                                                                                                                           | Display ID of the purchase order                                                                                                                             | 12345                                                                                                                                                        |
...
<!-- UsageSnippet language="python" operationID="accounting.purchaseOrdersOne" method="get" path="/accounting/purchase-orders/{id}" -->
```python
from apideck_unify import Apideck
import os
...
with Apideck(
    ...
    res = apideck.accounting.purchase_orders.get(id="<id>", service_id="salesforce", company_id="12345", raw=False)
...
<!-- UsageSnippet language="python" operationID="accounting.purchaseOrdersUpdate" method="patch" path="/accounting/purchase-orders/{id}" -->
```python
import apideck_unify
from apideck_unify import Apideck
from datetime import date
...
with Apideck(
    ...
    res = apideck.accounting.purchase_orders.update(id="<id>", service_id="salesforce", company_id_param="12345", raw=False, display_id="12345", po_number="90000117", reference="123456", supplier=apideck_unify.LinkedSupplierInput(
        id="12345",
        display_name="Windsurf Shop",
        address=apideck_unify.Address(
            id="123",
...
<!-- UsageSnippet language="python" operationID="accounting.purchaseOrdersDelete" method="delete" path="/accounting/purchase-orders/{id}" -->
```python
from apideck_unify import Apideck
import os
...
with Apideck(
    ...
    res = apideck.accounting.purchase_orders.delete(id="<id>", service_id="salesforce", company_id="12345", raw=False)
