...
with Apideck(
    ...
    res = apideck.accounting.purchase_orders.create(raw=False, service_id="salesforce", display_id="12345", po_number="90000117", reference="123456", supplier={
        "id": "12345",
...
with Apideck(
    ...
    res = apideck.accounting.purchase_orders.update(id="<id>", service_id="salesforce", raw=False, display_id="12345", po_number="90000117", reference="123456", supplier={
        "id": "12345",
        "display_name": "Windsurf Shop",
        "address": {
            "id": "123",
