...
with Apideck(
    ...
    if res.get_bills_response is not None:
        # handle response
        pass
...
with Apideck(
    ...
    res = s.accounting.bills.create(bill={
        "bill_number": "10001",
        "supplier": {
            "id": "12345",
        ...
        "line_items": [
            {
                ...
                "type": apideck.BillLineItemType.EXPENSE_ACCOUNT,
                "tax_amount": 27500,
                "total_amount": 27500,
                "quantity": 1,
                "unit_price": 27500.5,
        ...
        "status": apideck.BillStatus.DRAFT,
        "ledger_account": {
            "id": "123456",
            "nominal_code": "N091",
            "code": "453",
...
with Apideck(
    ...
    res = s.accounting.bills.get(id="<id>", service_id="salesforce", fields="id,updated_at")

    if res.get_bill_response is not None:
        # handle response
        pass
...
with Apideck(
    ...
    res = s.accounting.bills.update(id="<id>", bill={
        "bill_number": "10001",
        "supplier": {
            "id": "12345",
            "display_name": "Windsurf Shop",
...
with Apideck(
    ...
    res = s.accounting.bills.delete(id="<id>", service_id="salesforce")

    if res.delete_bill_response is not None:
        # handle response
        pass
