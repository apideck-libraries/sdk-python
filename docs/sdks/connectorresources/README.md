...
with Apideck(
    ...
    res = apideck.connector.connector_resources.get(id="<id>", resource_id="<id>", unified_api=apideck_unify.UnifiedAPI.CRM)
...
| `unified_api`                                                                                           | [Optional[models.UnifiedAPI]](../../models/unifiedapi.md)                                               | :heavy_minus_sign:                                                                                      | Specify unified API for the connector resource. This is useful when a resource appears in multiple APIs | crm                                                                                                     |
