...
with Apideck(
    ...
    if res.get_opportunities_response is not None:
        # handle response
        pass
...
| ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| `request`                                                                       | [models.CrmOpportunitiesAllRequest](../../models/crmopportunitiesallrequest.md) | :heavy_check_mark:                                                              | The request object to use for the request.                                      |
...
with Apideck(
    ...
    res = s.crm.opportunities.create(opportunity={
        ...
        "stage_last_changed_at": dateutil.parser.isoparse("2020-09-30T07:43:32.000Z"),
        "pass_through": [
            {
                "service_id": "<id>",
                "extend_paths": [
    ...
    if res.create_opportunity_response is not None:
        # handle response
        pass
...
| --------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| `opportunity`                                                                                                                                 | [models.OpportunityInput](../../models/opportunityinput.md)                                                                                   | :heavy_check_mark:                                                                                                                            | N/A                                                                                                                                           |                                                                                                                                               |
...
with Apideck(
    ...
    if res.get_opportunity_response is not None:
        # handle response
        pass
...
with Apideck(
    ...
    if res.update_opportunity_response is not None:
        # handle response
        pass
...
with Apideck(
    ...
    if res.delete_opportunity_response is not None:
        # handle response
        pass
