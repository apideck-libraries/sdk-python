...
| ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `request`                                                                           | [models.AccountingInvoicesAllRequest](../../models/accountinginvoicesallrequest.md) | :heavy_check_mark:                                                                  | The request object to use for the request.                                          |
...
with Apideck(
    ...
    res = s.accounting.invoices.create(invoice={
        ...
        "company_id": "12345",
        "invoice_date": dateutil.parser.parse("2020-09-30").date(),
        "due_date": dateutil.parser.parse("2020-09-30").date(),
        "terms": "Net 30 days",
        "po_number": "90000117",
        "reference": "123456",
        "status": apideck_unify.InvoiceStatus.DRAFT,
        "invoice_sent": True,
...
| --------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| `invoice`                                                                                                                                     | [models.InvoiceInput](../../models/invoiceinput.md)                                                                                           | :heavy_check_mark:                                                                                                                            | N/A                                                                                                                                           |                                                                                                                                               |
