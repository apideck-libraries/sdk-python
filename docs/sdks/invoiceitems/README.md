...
with Apideck(
    ...
    if res.get_invoice_items_response is not None:
        # handle response
        pass
...
with Apideck(
    ...
    res = s.accounting.invoice_items.create(invoice_item={
        ...
        "type": apideck_unify.InvoiceItemType.INVENTORY,
        "sales_details": {
            "unit_price": 27500.5,
            "unit_of_measure": "pc.",
            "tax_inclusive": True,
    ...
    if res.create_invoice_item_response is not None:
        # handle response
        pass
...
with Apideck(
    ...
    if res.get_invoice_item_response is not None:
        # handle response
        pass
...
with Apideck(
    ...
    if res.update_invoice_items_response is not None:
        # handle response
        pass
